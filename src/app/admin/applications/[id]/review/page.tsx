...
export default function LoanReviewPage() {
  ...
  return (
    <>
      <AdminNav>
        <LoadingOverlayWrapper active={loading} spinner text='Loading...'>
          <LoadingOverlayWrapper active={approveLoading} spinner text='Approving...'>
            <LoadingOverlayWrapper active={rejectLoading} spinner text='Rejecting...'>
              <LoadingOverlayWrapper active={counterLoading} spinner text='Countering...'>
                <div className="min-h-screen bg-gray-50 py-8">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
