...
export default function DocumentsPage() {
    ...
    const { data, isFetching: isFetchingFiles } = useFetchFile();
    ...
    const handleDelete = async (key: string) => {
        try {
            ...
            notifications.error(`Failed to delete file: ${err}`);
        }
    };

    return (
        <LoadingOverlayWrapper active={isFetchingFiles} spinner text='Loading your documents...'>
            <LoadingOverlayWrapper active={isUploadingFiles} spinner text='Uploading your documents...'>
                <LoadingOverlayWrapper active={isDeletingFile} spinner text='Deleting your document...'>
