...
export class LoanOffersRepository {
  ...
  static async create(data: Prisma.loan_offersCreateInput): Promise<loan_offers> {
    return prisma.loan_offers.create({ data });
  }

  static async findById(id: number): Promise<loan_offers | null> {
  ...
  static async delete(where: Prisma.loan_offersWhereUniqueInput): Promise<loan_offers> {
